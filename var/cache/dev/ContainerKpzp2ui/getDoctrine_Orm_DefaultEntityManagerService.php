...
if ($lazyLoad) {
    return $this->services['doctrine.orm.default_entity_manager'] = $this->createProxy('EntityManager_ac1b977', function () {
        return \EntityManager_ac1b977::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
...
$a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Acme/ContactBundle/Resources/config/doctrine') => 'Acme\\ContactBundle\\Entity', ($this->targetDirs[3].'/src/Acme/ActeurBundle/Resources/config/doctrine') => 'Acme\\ActeurBundle\\Entity', ($this->targetDirs[3].'/src/Acme/ActuBundle/Resources/config/doctrine') => 'Acme\\ActuBundle\\Entity'));
...
$b->addDriver($a, 'Acme\\ContactBundle\\Entity');
$b->addDriver($a, 'Acme\\ActeurBundle\\Entity');
$b->addDriver($a, 'Acme\\ActuBundle\\Entity');
...
$c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'AcmeContactBundle' => 'Acme\\ContactBundle\\Entity', 'AcmeActeurBundle' => 'Acme\\ActeurBundle\\Entity', 'AcmeActuBundle' => 'Acme\\ActuBundle\\Entity'));
...
$instance = \Doctrine\ORM\EntityManager::create(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->load(__DIR__.'/getDoctrine_Dbal_DefaultConnectionService.php')) && false ?: '_'}, $c);
