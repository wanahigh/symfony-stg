...
$c->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), new \Acme\ActuBundle\EventListener\UploadImageListener(new \Acme\ActuBundle\ImageUpload(($this->targetDirs[3].'/app/../web/uploads/images'))));
