...
namespace Proxies\__CG__\Acme\ContactBundle\Entity\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Contact extends \Acme\ContactBundle\Entity\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'id', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'nom', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'prenom', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'organisation', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'email', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'sujet', '' . "\0" . 'Acme\\ContactBundle\\Entity\\Entity\\Contact' . "\0" . 'message'];
        }
